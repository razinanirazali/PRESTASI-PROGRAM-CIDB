...
if ACTIVE_QUARTER == "JUL" and "STATUS_WARNA_EXCEL" in filtered_df.columns:
    # Untuk Julai, bilangan Hijau/Kuning/Merah mesti sama tepat dengan
    # keseluruhan format warna di Column AH Excel. Jangan keluarkan baris
    # status khas di sini kerana angka rasmi warna dalam Excel merangkumi
    # semua sel AH yang telah diwarnakan. Q3/Q4 dan 13 Gugur baharu masih
    # dikira berasingan melalui CATATAN (JUSTIFIKASI) JULAI.
...
# Julai: jumlah aktif mesti selaras tepat dengan kategori pada panel.
# 190 Hijau + 10 Kuning + 16 Merah + 2 Q3 + 18 Q4 = 236.
# Gugur baharu Julai tidak dimasukkan dalam jumlah program aktif.
if ACTIVE_QUARTER == "JUL":
    jumlah_program_panel = (
        hijau
        + kuning
